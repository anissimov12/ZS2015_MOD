...
LANGUAGE.humans_furthest_from_sigils_are_zombies	= "Игроки, находящиеся дальше всех от Сигилов, станут зараженными."

LANGUAGE.sigil										= "Точка связи"
LANGUAGE.sigil_corrupted							= "Точка связи была заражена. Зомби становится сильнее!"
LANGUAGE.sigil_corrupted_last						= "Последняя Точка связи была заражена! Зомби становятся очень сильными!"
LANGUAGE.sigil_uncorrupted							= "Точка связи была очищена, Зомби ослабли!"
