...
GM:AddStartingItem("boardpack", "Board Pack", nil, ITEMCAT_TOOLS, 40, "weapon_zs_boardpack")
...
GM:AddStartingItem("bfmusc", "Muscular", "You do 20% extra damage with melee weapons.", ITEMCAT_TRAITS, 25, nil, function(pl) pl.BuffMuscular = true pl:DoMuscularBones() end, "models/props_wasteland/kitchen_shelf001a.mdl")
...
GM:AddPointShopItem("crossbow", "'Impaler' Crossbow", nil, ITEMCAT_GUNS, 175, "weapon_zs_crossbow", nil, nil, 4)

GM:AddPointShopItem("sweeper", "'Sweeper' Shotgun", nil, ITEMCAT_GUNS, 200, "weapon_zs_sweepershotgun", nil, nil, 5)
GM:AddPointShopItem("boomstick", "Boom Stick", nil, ITEMCAT_GUNS, 200, "weapon_zs_boomstick", nil, nil, 5)
GM:AddPointShopItem("slugrifle", "'Tiny' Slug Rifle", nil, ITEMCAT_GUNS, 200, "weapon_zs_slugrifle", nil, nil, 5)
GM:AddPointShopItem("pulserifle", "'Adonis' Pulse Rifle", nil, ITEMCAT_GUNS, 225, "weapon_zs_pulserifle", nil, nil, 5)
...
GM:AddPointShopItem("6nails", "Box of 12 nails", "An extra box of nails for all your barricading needs.", ITEMCAT_TOOLS, 24, nil, function(pl) pl:GiveAmmo(12, "GaussEnergy", true) end, "models/Items/BoxMRounds.mdl")
GM:AddPointShopItem("150mkit", "150 Medical Kit power", nil, ITEMCAT_TOOLS, 30, nil, function(pl) pl:GiveAmmo(150, "Battery", true) end, "models/healthvial.mdl")
...
GM:AddPointShopItem("boardpack", "Board Pack", nil, ITEMCAT_TOOLS, 25, "weapon_zs_boardpack")
